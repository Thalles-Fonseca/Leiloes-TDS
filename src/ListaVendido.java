...
public class ListaVendido extends javax.swing.JFrame {
   ...
   private void carregarVendas() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaVendido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaVendido().setVisible(true);
            }
        });
    }
